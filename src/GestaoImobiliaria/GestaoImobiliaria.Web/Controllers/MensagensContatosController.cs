...
{
    public class MensagensContatosController : Controller
    {
        private readonly ImobiliariaDbContext _context;

        public MensagensContatosController(ImobiliariaDbContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Create()
        {
            ...
            ViewData["CorretorId"] = new SelectList(_context.Corretores, "CorretorId", "CorretorId");
        ...
        public async Task<IActionResult> Create([Bind("MensagemId,ImovelId,ClienteId,CorretorId,Mensagem,DataEnvio")] MensagensContato mensagensContato)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Clientes, "ClienteId", "ClienteId", mensagensContato.ClienteId);
            ViewData["CorretorId"] = new SelectList(_context.Corretores, "CorretorId", "CorretorId", mensagensContato.CorretorId);
            ViewData["ImovelId"] = new SelectList(_context.Imoveis, "ImovelId", "ImovelId", mensagensContato.ImovelId);
            return View(mensagensContato);
        }
