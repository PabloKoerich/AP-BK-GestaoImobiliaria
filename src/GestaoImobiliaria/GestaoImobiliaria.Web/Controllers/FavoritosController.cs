...
namespace GestaoImobiliaria.Web.Controllers
{
    public class FavoritosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FavoritoId,ClienteId,ImovelId,DataAdicionado")] FavoritoViewModel favorito)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Clientes, "ClienteId", "ClienteId", favorito.ClienteId);
            ViewData["ImovelId"] = new SelectList(_context.Imoveis, "ImovelId", "ImovelId", favorito.ImovelId);
            return View(favorito);
        }
